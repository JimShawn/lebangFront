define(['app','echarts','httpService','commonUtil','echartsTheme','jquery','bootstrap',
    ...
    app.controller('reportCompressiveController',['$scope','$location','$state','echartsTheme','httpService','commonUtil',function($scope, $location,$state,echartsTheme,httpService,commonUtil) {
        ...
        httpService.getTaskAppAtatistics(queryInitObj1).then(function (res) {
          ...
          for (var i = 0; i < content.length; i++) {
            ...
            numArray.push(content[i].acceptedAmount);
          };
